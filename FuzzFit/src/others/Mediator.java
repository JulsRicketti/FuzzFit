...
public class Mediator {
	...
	public ArrayList<String> getCalorieHistory() {
		return calorieHistory;
	}


	public void setCalorieHistory(ArrayList<String> calorieHistory) {
	...
	public void updateWalkerEntry(String recommendation, String activityDate, String activityDistance, String activityTime, String calories){
		...
		String averageVelocityString = String.format("%.2f", averageVelocity);
		String lastMonitor =  getMonitorHistory().get(getMonitorHistory().size()-1);
		history.updateDatabase(DatabaseAdapter.WALKER_HISTORY_TABLE, recommendation, activityDate, activityDistance, activityTime, averageVelocityString, lastMonitor , calories);
	...
	public void updateWeightLossEntry(String recommendation, String activityDate, String activityDistance, String activityTime, String calories){
		...
		String averageVelocityString = String.format("%.2f", averageVelocity);
		String lastMonitor =  getMonitorHistory().get(getMonitorHistory().size()-1);
		history.updateDatabase(DatabaseAdapter.WEIGHT_LOSS_HISTORY_TABLE, recommendation, activityDate, activityDistance, activityTime, averageVelocityString, lastMonitor , calories);
	...
	public void updateRunnerEntry(String recommendation, String activityDate, String activityDistance, String activityTime, String calories){
		...
		String averageVelocityString = String.format("%.2f", averageVelocity);		
		String lastMonitor =  getMonitorHistory().get(getMonitorHistory().size()-1);
		history.updateDatabase(DatabaseAdapter.RUNNER_HISTORY_TABLE, recommendation, activityDate, activityDistance, activityTime, averageVelocityString, lastMonitor , calories);
	}
	...
	public void buildWalkerEntry(String recommendation, String activityDate, String activityDistance, String activityTime, String calories){
		...
		averageVelocity *=3.6; //convert to km/h
		String averageVelocityString = String.format("%.2f", averageVelocity);	
		history.insert(DatabaseAdapter.WALKER_HISTORY_TABLE, recommendation, activityDate, activityDistance, activityTime,averageVelocityString, getMonitorResult(), calories);
	}
	...
	public void buildWeightLossEntry(String recommendation, String activityDate, String activityDistance, String activityTime, String calories){
		...
		averageVelocity *=3.6; //convert to km/h
		String averageVelocityString = String.format("%.2f", averageVelocity);			
		history.insert(DatabaseAdapter.WEIGHT_LOSS_HISTORY_TABLE, recommendation, activityDate, activityDistance, activityTime,averageVelocityString, getMonitorResult(), calories);
	}
	...
	public void buildRunnerEntry(String recommendation, String activityDate, String activityDistance, String activityTime, String calories){
		...
		averageVelocity *=3.6; //convert to km/h
		String averageVelocityString = String.format("%.2f", averageVelocity);
		history.insert(DatabaseAdapter.RUNNER_HISTORY_TABLE, recommendation, activityDate, activityDistance, activityTime,averageVelocityString, getMonitorResult(), calories);
	}
