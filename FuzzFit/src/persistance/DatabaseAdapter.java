...
public class DatabaseAdapter {
    ...
    private static final String RUNNER_TABLE_CREATE =        
            ...
            + "recommendation VARCHAR , activitydate VARCHAR , activity_distance VARCHAR , activity_time VARCHAR, activity_velocity VARCHAR, monitor VARCHAR);";
    ...
    public long insertActivity(String tableName, String recommendation, String activityDate, String activityDistance, String activityTime, String activityVelocity, String monitor){
    	ContentValues initialValues = new ContentValues();
    ...
    public Cursor getAllActivityRecords(String tableName){
        return db.query(tableName, new String[] { RECOMMENDATION, ACTIVITY_DATE,ACTIVITY_DISTANCE,ACTIVITY_TIME, ACTIVITY_VELOCITY, MONITOR}, null, null, null, null, null);
...
//    }
    ...
    public Cursor getPhysicalActivity(String tableName, long rowId) throws SQLException{
        Cursor mCursor =
                ...
                RECOMMENDATION, ACTIVITY_DATE, ACTIVITY_DISTANCE, ACTIVITY_TIME, ACTIVITY_VELOCITY, MONITOR}, 
                KEY_ROWID + "=" + rowId, null, null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
...
//    }
    ...
    public boolean updatePhysicalActivity(String tableName, String recommendation, String activityDate, String activityDistance, String activityTime,  String activityVelocity, String monitor ){
    	 ContentValues args = new ContentValues();
